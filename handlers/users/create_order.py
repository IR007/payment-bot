...
from data.products import python_book, ds_praktikum, FAST_SHIPPING, REGULAR_SHIPPING, PICKUP_SHIPPING, ONE_WEEK_SHIPPING
...
async def show_invoices(message: types.Message):
    ...
    await message.answer_photo(photo="https://rukminim2.flixcart.com/image/850/1000/kq8dua80/book/v/f/2/zero-to-mastery-in-python-programming-best-python-book-for-original-imag4ab2gzadhskq.jpeg?q=90",
...
async def show_invoices(message: types.Message):
    ...
    await message.answer_photo(photo="https://files.glotr.uz/company/000/025/421/products/2021/07/12/2021-07-12-10-24-35-183912-95803e7db7edc54aac832818f69ef30a.jpg?_=ozbol",
...
async def choose_shipping(query: types.ShippingQuery):
    if query.shipping_address.country_code != "UZ":
        ...
        await bot.answer_shipping_query(shipping_query_id=query.id,
                                        shipping_options=[ONE_WEEK_SHIPPING, FAST_SHIPPING, REGULAR_SHIPPING, PICKUP_SHIPPING],
                                        ok=True)
    else:
        await bot.answer_shipping_query(shipping_query_id=query.id,
                                        shipping_options=[ONE_WEEK_SHIPPING, REGULAR_SHIPPING],
                                        ok=True)
